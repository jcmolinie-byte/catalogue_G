...
export default function App() {
  ...
  const analyzePhoto = async () => {
    ...
    try {
      ...
      const canvas = document.createElement('canvas');
      const maxSize = 1024; // Plus standard pour Mistral Pixtral
        ...
        body: JSON.stringify({
          ...
          messages: [{
            ...
            content: [
              {
                type: 'text',
                text: "Analyse cette plaque industrielle. Extrais les infos au format JSON : raw_ocr, type, brand, model, specs (liste), description."
              },
              {
                type: 'image_url',
