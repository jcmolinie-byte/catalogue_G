...
import { 
  ...
  LayoutGrid, ScanLine, Home, StickyNote, Trash2, Plus, Pencil, ImageIcon, Share2, ShoppingCart, Minus, Wrench, Settings, Sun, Moon
} from 'lucide-react';
        ...
        body: JSON.stringify({
          ...
          messages: [{
            ...
            content: [
              ...
              {
                type: 'text',
                text: `Analyse cette plaque technique. 
                1. Retranscris d'abord TOUT le texte visible de manière brute (OCR).
                2. Extrais ensuite les informations structurées.
                Réponds UNIQUEMENT avec un JSON valide :
{"raw_ocr":"tout le texte lu sur la plaque","type":"moteur/pompe/etc","brand":"marque","model":"reference exacte","specs":["valeurs techniques"],"description":"resume"}`
              }
            ]
          }]
        })
