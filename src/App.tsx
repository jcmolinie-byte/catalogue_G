...
export default function App() {
  ...
  const analyzePhoto = async () => {
    ...
    try {
      ...
      // Initialisation Gemini en version STABLE (v1)
      ...
      const resultIA = await model.generateContent({
        contents: [{
          role: 'user',
          parts: [
            { text: promptIA },
      ...
      const textContent = responseIA.text();
              ...
              <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 border border-gray-200 dark:border-slate-700 shadow-sm">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-gray-400">Propulsé par Google Gemini 1.5 Pro</p>
                  </div>
                </div>
