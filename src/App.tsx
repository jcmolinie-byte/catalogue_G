  ...
  const analyzePhoto = async () => {
    ...
    try {
            ...
            content: [
              {
                ...
                - brand: marque
                - model: reference
                - specs: TOUTES les valeurs techniques (KW, RPM, V, A, Hz...) - TRÈS IMPORTANT : Identifie clairement la puissance en kW.
      ...
      try {
        ...
        throw new Error(`Réponse IA non parsable : ${jsonContent.substring(0, 150)}`);
      }
