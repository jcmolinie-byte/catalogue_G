  ...
  const startCamera = async () => {
    try {
      ...
      hints.set(DecodeHintType.POSSIBLE_FORMATS, [
        BarcodeFormat.CODE_128,  // format principal Tereos
        BarcodeFormat.CODE_39,
        BarcodeFormat.QR_CODE,
      ]);
      hints.set(DecodeHintType.TRY_HARDER, true);
      // Ne pas activer ASSUME_GS1 : nos codes SAP ne sont pas au format GS1
      ...
      // Résolution réduite pour meilleures performances mobile avec ZXing JS
      ...
      await codeReaderRef.current.decodeFromConstraints(
        ...
        (result, err) => {
          ...
          // Ignorer silencieusement les NotFoundException (frame sans code)
