...
const CATALOG_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vR9igkI8LVEXYO6dIwbfdOAVeFm4osuDtOXDbo6m2WOOXz1-v9fkmSH5z30-26bk9s9Q2tOZayk9H6x/pub?output=csv';
const EQUIPMENTS_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTmo5zMmaiq0abOpLcjudLHUseHYCMi13oODti08v_oJ4b-S6NOGmxzB6BaYDaGWu7lxDN-EMLIGad8/pub?output=csv';
    ...
    try {
      ...
      return json.map((row: any, index) => {
        ...
        return {
          ...
          sapCode: String(getValue(['Code Article', 'Article', 'SAP', 'Code SAP', 'Référence']) || 'N/A'),
              ...
              {!selectedEquipmentId ? (
                <div className="space-y-2">
                  {Array.from(new Set(equipments.filter(e => 
                    (e.equipment && e.equipment.toLowerCase().includes(equipmentSearchQuery.toLowerCase())) || 
                    (e.equipmentLabel && e.equipmentLabel.toLowerCase().includes(equipmentSearchQuery.toLowerCase())) ||
