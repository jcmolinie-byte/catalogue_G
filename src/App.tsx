            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 w-full max-w-md">
                ...
                >
                  ...
                  <div className="relative text-center">
                    <p className="font-bold text-gray-900 dark:text-white text-sm">Appareil Photo</p>
                    <p className="text-[11px] text-gray-400 dark:text-gray-400 mt-0.5">Capturer ou Scanner</p>
                  </div>
                </motion.button>
                ...
                >
                  ...
                  <div className="relative text-center">
                    <p className="font-bold text-gray-900 dark:text-white text-sm">Galerie Photo</p>
                    <p className="text-[11px] text-gray-400 dark:text-gray-400 mt-0.5">Analyser un fichier</p>
                  </div>
                </motion.button>
                ...
                >
                  ...
                  <div className="relative text-center">
                    ...
                    <p className="text-[11px] text-gray-400 dark:text-gray-400 mt-0.5">Charger Excel</p>
                  </div>
                </motion.button>
              ...
              <div className="flex-1 relative flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute bottom-12 left-0 right-0 flex flex-col items-center gap-4 px-4">
                  <div className="flex gap-3 w-full max-w-md">
                    <button onClick={analyzePhoto} disabled={isAnalyzing} className="flex-1 flex items-center justify-center gap-2 px-4 py-4 bg-white text-blue-600 rounded-2xl font-bold shadow-xl active:scale-95 transition-all">
                      {isAnalyzing ? <div className="w-5 h-5 border-2 border-blue-600 border-t-transparent rounded-full animate-spin" /> : <Search size={20} />}
                      {isAnalyzing ? 'Analyse...' : 'Identifier (IA)'}
                    </button>
                    <button onClick={capturePhotoForNote} className="flex-1 flex items-center justify-center gap-2 px-4 py-4 bg-slate-800/80 backdrop-blur-md text-white border border-slate-700 rounded-2xl font-bold shadow-xl active:scale-95 transition-all">
                      <Camera size={20} />
                      Photo Note
                    </button>
                  </div>
