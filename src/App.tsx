          ...
          messages: [
            {
              ...
              content: [
                ...
                {
                  type: 'text',
                  text: `Tu es un assistant magasin industriel spécialisé en pièces détachées. Analyse cette photo en deux étapes :

ÉTAPE 1 — OCR ET RECONNAISSANCE VISUELLE :
- Si la photo montre une plaque signalétique (moteur, réducteur, pompe, variateur...) : lis et extrais tout le texte visible (marque, modèle, type, puissance, n° de série, tension, fréquence, rapport de réduction, etc.)
- Si la photo montre directement une pièce : identifie sa nature (roulement, courroie, vanne, joint, filtre, palier, accouplement, etc.) et ses caractéristiques visibles (dimensions, forme, couleur, marquages)
- Dans les deux cas, produis une description complète de ce que tu lis/vois

ÉTAPE 2 — MATCHING CATALOGUE :
À partir de cette description, trouve les articles SAP les plus proches dans ce catalogue (format CODE_SAP|DESIGNATION) :
${itemNames}

Retourne UNIQUEMENT un JSON valide, sans texte autour, sans backticks :
{
  "description": "texte OCR extrait + description de la pièce (ex: Moteur SEW K37 DT71D4, 0.37kW, 1400tr/min)",
  "matches": [
    {"sapCode": "123456789", "name": "Désignation article", "score": 95},
    {"sapCode": "987654321", "name": "Autre article similaire", "score": 80}
  ]
}

Retourne les 5 meilleures correspondances triées par score décroissant. Si aucune correspondance, retourne matches vide.`,
                },
              ],
            },
          ],
