                ...
                <div className="space-y-4">
                  ...
                  <div className="mt-4">
                    ...
                    <p className="text-[10px] text-gray-400 px-1 mt-1.5 leading-relaxed">
                      Obtenez une clé gratuite sur <a href="https://console.groq.com/" target="_blank" rel="noopener noreferrer" className="text-green-500 underline">console.groq.com</a>. Utilisé automatiquement si Gemini est saturé.
                    </p>
                  </div>
                </div>
              </div>
