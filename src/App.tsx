            ...
            content: [
              {
                ...
                1. Retranscris d'abord TOUT le texte visible de manière brute (OCR).
                2. Extrais ensuite les informations structurées suivantes au format JSON :
                - raw_ocr: tout le texte lu
                - type: moteur, pompe, etc.
                - brand: marque fabricant
                - model: reference exacte
                - specs: liste des valeurs (ex: 0.75kW, 230V)
                - description: court resume
