...
export default function App() {
  ...
  const startCamera = async () => {
    ...
    try {
      ...
      if (!videoRef.current) {
        // Retry once if video element is not yet available
      ...
      // Don't alert if we're not in scan view anymore (user might have left)
      if (view === 'scan') {
  ...
  const handleScan = () => {
    ...
    setTimeout(() => {
      ...
      setScanResult(`Code détecté: ${randomItem.sapCode}`);
            ...
            >
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex gap-3">
                  <button className="flex-1 bg-white border border-gray-200 text-gray-900 py-4 rounded-2xl font-bold hover:bg-gray-50 active:scale-95 transition-all">
                    Historique
                  </button>
                </div>
              </div>
