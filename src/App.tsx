...
export default function App() {
  ...
  const toggleVoiceSearch = () => {
    ...
    recognition.interimResults = false; // Désactivé pour éviter les faux-départs sur mots courts
    recognition.maxAlternatives = 1;

    recognition.onstart = () => setIsListening(true);
    
    recognition.onresult = (event: any) => {
      // On prend uniquement le dernier résultat final
      ...
      transcript = transcript
        .toLowerCase()
        .replace(/[.,!?]/g, '') // Supprime toute ponctuation
        .trim();
      
      // Correction des chiffres espacés
