...
// Ce composant se place dans src/Inventaire.tsx (a cote de App.tsx).
// Il recoit onRetour pour revenir a l'accueil de SAM.
...
// COMPOSANT
// =====================================================================
export default function Inventaire({ onRetour }: { onRetour: () => void }) {
  ...
  if (etape === 'zones') {
    return (
      <div style={S.page}>
        <button style={S.retour} onClick={onRetour}>&larr; Retour</button>
...
const S: Record<string, React.CSSProperties> = {
  retour: { background: 'none', border: 'none', color: '#2563eb', fontSize: 15, fontWeight: 600, cursor: 'pointer', padding: '4px 0', marginBottom: 8 },
